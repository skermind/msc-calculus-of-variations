...
In this chapter, we introduce the problem we want to study in this dissertation as an application of calculus of variations, and derive the mathematical model for it. 
...
terrain on the two-dimensional Euclidean space and let $a,b \in \Omega$ denote the prescribed start and end
points, respectively. An admissible path is represented by a
sufficiently smooth curve defined by
\[
\gamma : [0,1] \rightarrow \mathbb{R}^2,
\]
and satisfying the boundary conditions given as
\[
\gamma(0)=a,
\qquad
\gamma(1)=b.
